            ...
            public void run() {
                ...
                if (bbudatas.size() > 0) {
                    if (paTempdatas.size() > 0) {
                        BBuBean.BbuStatusBean mBean = bbudatas.get(bbudatas.size() - 1).getBbuStatusBean();
        ...
        ThreadUtils.getThreadPoolProxy().execute(new Runnable() {
            ...
            public void run() {
                ...
                if (list.size() > 0) {
                    ...
                    if (bean.getCode()!=null&&bean.getCode().equals(4615)) {
        ...
        ThreadUtils.runOnMainThread(new Runnable() {
            ...
            public void run() {
                if (type == 8) {
                    ...
                    btn2.setBackgroundResource(R.drawable.button_unclick);
                    btn3.setClickable(true);
                    btn3.setBackgroundResource(R.drawable.btn_selector);
                    btn4.setText("切换电信");
                    btn4On = true;
                } else if (type == 9) {
                    btn3.setClickable(false);
                    btn3.setBackgroundResource(R.drawable.button_unclick);
                    btn2.setClickable(true);
                    btn2.setBackgroundResource(R.drawable.btn_selector);
                    btn4.setText("切换联通");
                    btn4On = false;
                }
            }
