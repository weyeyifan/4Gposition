    ...
    public DevBean queryByCity(String city){
        ...
        if(cursor!=null){
            while (cursor.moveToNext()){
                ...
                bean.delay_b38=cursor.getString(8);
                bean.freq_yidong_b38=cursor.getString(9);
                bean.delay_b39=cursor.getString(10);
                bean.freq_yidong_b39=cursor.getString(11);
                bean.delay_b40=cursor.getString(12);
                bean.freq_yidong_b40=cursor.getString(13);
